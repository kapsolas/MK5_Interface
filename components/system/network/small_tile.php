...
Wlan1 <?= wlan1_status() == true ? '<font color="lime">Enabled</font>.&nbsp; | <a href="#sys/network/disable/wlan1/refresh_network">Disable</a>' : '<font color="red">Disabled</font>. | <a href="#sys/network/enable/wlan1/refresh_network">Enable</a>';  ?><br />
Wlan2 <?= wlan2_status() == true ? '<font color="lime">Enabled</font>.&nbsp; | <a href="#sys/network/disable/wlan2/refresh_network">Disable</a>' : '<font color="red">Disabled</font>. | <a href="#sys/network/enable/wlan2/refresh_network">Enable</a>';  ?><br /> <br />  
